...
def convert_to_dfa(
    ...
    while nao_processado:
        ...
        current_state_name = mapeamento[subset_atual]

        if not subset_atual.isdisjoint(dfa_final):
            novo_estado_final.add(current_state_name)

        estados_novos.add(current_state_name)
        ...
        for simbolo in sigma:
            ...
            if proximo:
                ...
                nova_transicao[(current_state_name, simbolo)] = mapeamento[proximo]
